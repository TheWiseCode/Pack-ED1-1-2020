...
void interseccionOtro(ConjuntoListaPtr a, ConjuntoListaPtr b,
...
void interseccionDayana(ConjuntoListaPtr a, ConjuntoListaPtr b,
	...
	while (!a.vacio()) {
		int elemento = a.muestrea();
		if (a.pertenece(elemento) && b.pertenece(elemento)
		&& c.pertenece(elemento))
			cr.inserta(elemento);
		a.suprime(elemento);
		auxiliar.inserta(elemento);
	}
