...
void CSMemoria::mostrar_memoria() {
	...
	string cabecera = cab_dir + "|" + cab_id + "|" + cab_dato + "|" + cab_link;
	string linea = repetir(cabecera.length(), '-');
	cout << cabecera << endl;
	cout << linea << endl;
	for (int i = 0; i < max_memoria; i++) {
	...
	cout << linea << endl;
	cout << "Libre : " << to_string(libre) << endl;
	// cout << "Memoria disponible : " << to_string(espacio_disponible()) << endl;
	// cout << "Memoria ocupado : " << to_string(espacio_ocupado()) << endl;
}
